...
const TYPES = [
  {
    ...
    meme: '"그거 출처가 어디야?"',
    memeTags: ['#인간_구글스칼라', '#근거없으면_안믿음', '#최후의_보루', '#체크리스트_인간', '#계획표_사랑', '#마감_전날_이미_끝냄'],
  ...
  },
  {
    ...
    strengths: ['남들이 놓친 잔업을 조용히 다 처리해 둔다', '주변 사람 각각의 사정을 다 기억하고 배려한다', '반복 작업의 정확도가 무섭게 높다'],
    caution: '혼자 다 떠안고 아무 말 안 하다가 조용히 번아웃 옴',
    meme: '"다들 밥은 먹었어…?"',
    memeTags: ['#소리없는_에이스', '#거절을_못함', '#단톡방_읽씹_안함', '#남_생일_다_기억', '#괜찮아요_기계', '#뒤에서_다_해놓음'],
  ...
  },
  {
    ...
    strengths: ['주제의 "진짜 하고 싶은 말"을 한 문장으로 뽑아낸다', '사람들 사이의 미묘한 공기를 먼저 감지한다', '말 한마디에 의미를 심어 오래 남게 만든다'],
    caution: '머릿속에서 이미 완성했는데 입 밖으로 안 꺼내서 아무도 모름',
    meme: '"나 사실 처음부터 알고 있었어"',
    memeTags: ['#손절의_신', '#말안해도_다_읽음', '#혼자_결론_다냄', '#속마음_3단계', '#의미부여_장인', '#조용한_통찰'],
  ...
  },
  {
    ...
    meme: '"그거 비효율적인데요"',
    memeTags: ['#머릿속_시뮬레이션_100판', '#계획표_이미_완성', '#인간_전략시뮬', '#비효율_알레르기', '#혼자_다_함', '#설명_생략'],
  ...
  },
  {
    ...
    meme: '"일단 뜯어보자"',
    memeTags: ['#과묵한_해결사', '#말보다_손이_빠름', '#감정소모_사절', '#일단_분해', '#관심없으면_진짜_0', '#실물이_답'],
  ...
  },
  {
    ...
    memeTags: ['#겉바속촉', '#싫은데_싫다고_못함', '#PPT_장인', '#취향_확고', '#조용한_고집', '#분위기_안깨기'],
  ...
  },
  {
    ...
    memeTags: ['#상상속의_나는_이미_발표왕', '#감성_담당', '#마감_전날_각성', '#머릿속_시나리오_무한', '#진심_과다', '#혼자_감동'],
  ...
  },
  {
    ...
    strengths: ['용어 정의를 잡아줘서 다 같이 헛수고하는 걸 막는다', '반례를 미리 찾아 나중에 안 털리게 한다', '남들이 안 보는 구조적 허점을 발견한다'],
    caution: '완벽한 정의를 찾다가 정작 결과물 제출이 늦어짐',
    meme: '"근데 그거 정의가 뭐야?"',
    memeTags: ['#논리회로_과열', '#반례_수집가', '#탭_47개_열려있음', '#정의부터_합시다', '#딴생각_고속도로', '#결론은_나중에'],
  ...
  },
  {
    ...
    meme: '"고민할 시간에 이미 다녀옴"',
    memeTags: ['#일단_고', '#멘탈_티타늄', '#현장_뚫는_사람', '#고민은_사치', '#몸이_먼저', '#협상_본능'],
  ...
  },
  {
    ...
    strengths: ['그 자리 공기를 혼자 바꿔놓는다', '지루한 내용을 재밌게 포장한다', '분위기가 처질 때 혼자서 살려낸다'],
    caution: '준비 과정이 지루하면 후반에 몰아치기 발동',
    meme: '"일단 재밌으면 됐지"',
    memeTags: ['#인간_비타민', '#무대체질', '#분위기_담당', '#지금이_제일_중요', '#즉흥의_신', '#사진_100장'],
  ...
  },
  {
    ...
    strengths: ['30분 만에 아이디어를 산더미로 뽑는다', '전혀 다른 분야를 주제에 엮어 신선하게 만든다', '옆에 있는 사람까지 끌어들인다'],
    caution: '아이디어 300개 중 실행되는 게 0개일 위험',
    meme: '"아이디어 300개 있는데 실행은 0개야"',
    memeTags: ['#텐션_만렙', '#시작은_창대', '#인싸력_MAX', '#아이디어_홍수', '#주제_세번_바뀜', '#사람_좋아'],
  ...
  },
  {
    ...
    memeTags: ['#악마의_변호인', '#토론_배틀_환영', '#판_뒤집기_장인', '#근데_말이야', '#떡밥_투척', '#재치_과다'],
  ...
  },
  {
    ...
    meme: '"그래서 마감이 언제라고?"',
    memeTags: ['#엑셀_장인', '#인간_알람', '#무임승차_박멸', '#마감이_생명', '#결론부터', '#표로_정리함'],
  ...
  },
  {
    ...
    strengths: ['사람들 스케줄을 맞춰 실제로 모이게 만든다', '갈등을 조용히 중재한다', '빠진 부분을 챙겨 결과물을 완성 상태로 만든다'],
    caution: '모두를 만족시키려다 정작 결론이 흐려짐',
    meme: '"우리 조 단톡방 팠어! 다들 확인 좀 🙏"',
    memeTags: ['#챙김_대마왕', '#단톡방_개설자', '#리마인드_요정', '#모두_만족_추구', '#안부_먼저', '#중재_본능'],
  ...
  },
  {
    ...
    strengths: ['각자의 강점에 맞춰 할 일을 나눈다', '말로 사람을 실제로 움직인다', '팀에 "왜 하는지"를 심어준다'],
    caution: '남 챙기느라 자기 파트를 뒤로 미룸',
    meme: '"다들 할 수 있어!! 우리 진짜 잘하고 있어!!"',
    memeTags: ['#인간_확성기', '#팀장_1순위', '#동기부여_자판기', '#칭찬으로_일_시킴', '#남_먼저_챙김', '#분위기_설계자'],
  ...
  },
  {
    ...
    strengths: ['목표와 각자 할 일을 첫 판에 확정한다', '결정을 미루지 않아 일정이 안 밀린다', '전체 그림과 실행을 동시에 잡는다'],
    caution: '반대 의견을 비효율로 취급하면 조가 조용해진다',
    meme: '"회의 10분 컷. 각자 뭐 할지 정리해서 올려."',
    memeTags: ['#CEO_빙의', '#회의_10분컷', '#결론부터_말해', '#목표부터_설정', '#속도가_생명', '#반박은_논리로'],
