  ...
  people: {
    pos: {
      ...
      S: ['당장 직접 피해 보는 사람이 눈에 보이잖아.',
        '지금 그만두게 되는 사람이 실제로 있어. 그게 먼저야.'],
      T: ['길게 보면 사람이 자산이야. 이건 감정 아니라 계산이야.',
        '재교육 비용이 이직 비용보다 싸. 숫자로도 이쪽이야.'],
      F: ['이건 양보 못 해. 사람이 먼저야.',
